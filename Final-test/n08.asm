...
count:
	lb $t0, 0($s0)  		#load gia tri cua byte dau tien = t0 
					#load tung byte 1
	beq $t0, '\n', endcount 	# neu t0 - kí tu xuong dong, ket thuc chuoi
...
#sp la bo nho stack()su dung khi goi nhieu ham long nhau
printline: 				#a0 = 0
